...
<div class="flex-vcenter mb-1">
 ...
 <div class="flex-vcenter mb-1">
  ...
  <p class="m-0">
  <span class="statusbot-title">Spark ut knapp</span> - Angi rollen som kan bruke spark-knappen.<br/>
  <span class="statusbot-title">Bryter</span> - Aktiver eller deaktiver knappen.<br/>
  For å angi dette: <span class="code-text">/config buttons kick True/False</span> <span class="discord-text">@rolle</span>
  </p>
 </div>
  <div class="flex-vcenter mb-1">
