...
<tr>
    <th scope="row">Volledige <a href="/category/api">API</a> toegang</th>
    <td></td>
    <td class="text-center"><i class="fas fa-fw fa-check-circle text-success"></i></td>
    <td class="text-center"><i class="fas fa-fw fa-check-circle text-success"></i></td>
    <td class="text-center"><i class="fas fa-fw fa-check-circle text-success"></i></td>
...
<tr>
    <th scope="row">Voertuig reparatie <a href="/stormworks/commands#vehicle-manager-commands">commando</a></th>
    <td></td>
    <td></td>
    <td class="text-center"><i class="fas fa-fw fa-check-circle text-success"></i></td>
    <td class="text-center"><i class="fas fa-fw fa-check-circle text-success"></i></td>
...
<tr>
    <th scope="row"><a href="/stormworks/commands">Huis</a> limiet</th>
...
<tr>
    <th scope="row"><a href="/stormworks/commands">Voertuig</a> limiet (HRP3: 3)</th>
    <td class="text-center"><i class="fa-fw text-success">2</i></td>
    <td class="text-center"><i class="fa-fw text-success">3</i></td>
    <td class="text-center"><i class="fa-fw text-success">3</i></td>
    <td class="text-center"><i class="fa-fw text-success">4</i></td>
